...
An example microbiome dataset from github is used to display the 'zitools' 
workflow. The data used here are described in 
[Giloteaux et. al.]{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4918027/} and 
are available from [GitHub]{https://github.com/Nick243/Create-Giloteaux-2016-Phyloseq-Object/blob/master/ps_giloteaux_2016.rds} 

The study, in which this dataset was generated, was conducted to investigate the
gut microbiome of individuals diagnosed with myalgic encephalomyelitis/chronic
fatigue syndrome (ME/CFS). Therefore, the gut microbial diversity was analysed
by performing 16S rRNA sequencing obtained from stool samples. The dataset
comprises 39 control samples and 48 cases. 

In a first step, the dataset is loaded. 

```{r Dataset}
download.file("https://raw.githubusercontent.com/Nick243/Create-Giloteaux-2016-Phyloseq-Object/master/ps_giloteaux_2016.rds",destfile = "ps_giloteaux_2016.RDS")
phyloseq <- readRDS("ps_giloteaux_2016.RDS")
```
...
as factorial predictor variables when fitting a zero inflated negative binomial 
